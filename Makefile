...
# the following CFLAGS is for CRAY
    CFLAGS=-c -O2 -DNDEBUG=1 -DPRINT_AVG_LEN=1 -DDEBUG_TIMING=0 -DUSE_COOPLINUX \
		   ...
		   -I$(HOME)/apps/include \
		   -L$(HOME)/apps/lib \
		   -L$(HOME)/Projects/Hobbes/cray/coopsched/coopsched_linux \
		   -L$(HOME)/Projects/Hobbes/df_shm
    INSTALL_PREFIX=$(HOME)/apps
endif

OBJs=goldrush.o goldrush_f.o gr_internal.o gr_perfctr.o gr_stub.o gr_phase.o
